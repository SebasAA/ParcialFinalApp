...
import com.example.pdmsebasa.parcial3.adapters.ProductoUserAdapter;
import com.example.pdmsebasa.parcial3.database.entities.Producto;

import java.util.ArrayList;
import java.util.List;

public class ProductListUserFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ProductoUserAdapter adapter = new ProductoUserAdapter(list);
